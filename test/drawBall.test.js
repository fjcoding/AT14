...
test("Verify function getPaddleY, getting the value => 150 from the constructor ", () => {
...
test("Verify that arc function is receiving right arguments from the consturctor", () => {
  const paddle = new Paddle(cvs, 100, 20, 30, 5);
  const paddleY = paddle.y;
  const ball = new Ball(200, 100, 8, 4, 3, -3);
  const drawingBall = new drawBall(ctx, cvs, paddleY, ball);
...
test("Verify that FillStyle function is receiving the right color chosen by the team", () => {
  const paddle = new Paddle(cvs, 100, 20, 30, 5);
  const paddleY = paddle.y;
  const ball = new Ball(200, 100, 8, 4, 3, -3);
  const drawingBall = new drawBall(ctx, cvs, paddleY, ball);
...
test("Verify that StrockStyle function is receiving the right color chosen by the team", () => {
  const paddle = new Paddle(cvs, 100, 20, 30, 5);
  const paddleY = paddle.y;
  const ball = new Ball(200, 100, 8, 4, 3, -3);
  const drawingBall = new drawBall(ctx, cvs, paddleY, ball);
